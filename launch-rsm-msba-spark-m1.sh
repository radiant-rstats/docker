...
if [ "$ARG_TAG" != "" ]; then
  ...
  ## see https://urldefense.proofpoint.com/v2/url?u=https-3A__stackoverflow.com_questions_34051747_get-2Denvironment-2Dvariable-2Dfrom-2Ddocker-2Dcontainer&d=DwIGAg&c=-35OiAkTchMrZOngvJPOeA&r=Fl9jXwBiBhOXNPxlgSZKqSEZiBiPWs1diKtm8L8hkjw&m=dKnl0Zu1E_xKFdSYdXmzt7bxtrBIg5RlcxG-BpgA_VrGxp0RzlpV-l_r-7ohiVX6&s=cX-m3kM52rFaxRdsH7D9fuyDtpH-DurhVmyqqOsDRzo&e= 
...
if [ "${has_docker}" == "" ]; then
  ...
  ## based on https://urldefense.proofpoint.com/v2/url?u=https-3A__stackoverflow.com_questions_22009364_is-2Dthere-2Da-2Dtry-2Dcatch-2Dcommand-2Din-2Dbash&d=DwIGAg&c=-35OiAkTchMrZOngvJPOeA&r=Fl9jXwBiBhOXNPxlgSZKqSEZiBiPWs1diKtm8L8hkjw&m=dKnl0Zu1E_xKFdSYdXmzt7bxtrBIg5RlcxG-BpgA_VrGxp0RzlpV-l_r-7ohiVX6&s=9yj7Q4abNzAcVfxUU03DbXLALjkroO7kPJHvpSoglhY&e= 
  {
    docker ps -q 2>/dev/null
  } || {
    if [[ "$ostype" == "Darwin" ]]; then
      ## from https://urldefense.proofpoint.com/v2/url?u=https-3A__stackoverflow.com_a_48843074_1974918&d=DwIGAg&c=-35OiAkTchMrZOngvJPOeA&r=Fl9jXwBiBhOXNPxlgSZKqSEZiBiPWs1diKtm8L8hkjw&m=dKnl0Zu1E_xKFdSYdXmzt7bxtrBIg5RlcxG-BpgA_VrGxp0RzlpV-l_r-7ohiVX6&s=7QWzPNolhhYwV7ksc48tLpzvPq--NuoKCSkAsr8yBC4&e= 
  ...
  ## based on https://urldefense.proofpoint.com/v2/url?u=https-3A__stackoverflow.com_a_52852871_1974918&d=DwIGAg&c=-35OiAkTchMrZOngvJPOeA&r=Fl9jXwBiBhOXNPxlgSZKqSEZiBiPWs1diKtm8L8hkjw&m=dKnl0Zu1E_xKFdSYdXmzt7bxtrBIg5RlcxG-BpgA_VrGxp0RzlpV-l_r-7ohiVX6&s=Ee3_q0aLfY_bo-zQ5DCkAa07Vm5rbHAF6LvOdaHoU4k&e= 
  ...
  show_service () {
    ...
    if [ -z "${menu_exec}" ]; then
      ...
      if [ "${menu_arg}" == "" ]; then
        ...
        echo "Starting RStudio in the default browser on localhost:8989/rstudio. Copy-Paste the following in the console window, followed by [ENTER]"
        echo "radiant:::radiant()"
        sleep 6
        open_browser http://localhost:8989/rstudio
      else
        echo "Starting Rstudio in the default browser on localhost:${menu_arg}/rstudio. Copy-Paste the following in the console window, followed by [ENTER]"
        echo "radiant:::radiant()"
        sleep 6
        { 
          docker run --net ${NETWORK} -d \
      ...
      if [ "${menu_arg}" == "" ]; then
        ...
        open_browser open_browser http://localhost:8989/vscode
      else
      ...
      if [ $ostype == "ChromeOS" ]; then
        sudo -- bash -c "rm -f /usr/local/bin/launch; curl https://urldefense.proofpoint.com/v2/url?u=https-3A__raw.githubusercontent.com_radiant-2Drstats_docker_master_launch-2D-24LABEL-2Dchromeos.sh&d=DwIGAg&c=-35OiAkTchMrZOngvJPOeA&r=Fl9jXwBiBhOXNPxlgSZKqSEZiBiPWs1diKtm8L8hkjw&m=dKnl0Zu1E_xKFdSYdXmzt7bxtrBIg5RlcxG-BpgA_VrGxp0RzlpV-l_r-7ohiVX6&s=6gMpjHJxaASfHBvCOcRzImWlj8lgIt6nN4aIWbuGEXE&e=  -o /usr/local/bin/launch; chmod 755 /usr/local/bin/launch";
        /usr/local/bin/launch "${@:1}"
      elif [ $ostype == "WSL2" ]; then
        sudo -- bash -c "rm -f /usr/local/bin/launch; curl https://urldefense.proofpoint.com/v2/url?u=https-3A__raw.githubusercontent.com_radiant-2Drstats_docker_master_launch-2D-24LABEL.sh&d=DwIGAg&c=-35OiAkTchMrZOngvJPOeA&r=Fl9jXwBiBhOXNPxlgSZKqSEZiBiPWs1diKtm8L8hkjw&m=dKnl0Zu1E_xKFdSYdXmzt7bxtrBIg5RlcxG-BpgA_VrGxp0RzlpV-l_r-7ohiVX6&s=AN1SKjUPVTLYcddPUHdX0Im5iuGM-SBDQdA0Ypl6X9I&e=  -o /usr/local/bin/launch; chmod 755 /usr/local/bin/launch";
        /usr/local/bin/launch "${@:1}"
      else 
        curl https://urldefense.proofpoint.com/v2/url?u=https-3A__raw.githubusercontent.com_radiant-2Drstats_docker_master_launch-2D-24-257BLABEL-257D.sh&d=DwIGAg&c=-35OiAkTchMrZOngvJPOeA&r=Fl9jXwBiBhOXNPxlgSZKqSEZiBiPWs1diKtm8L8hkjw&m=dKnl0Zu1E_xKFdSYdXmzt7bxtrBIg5RlcxG-BpgA_VrGxp0RzlpV-l_r-7ohiVX6&s=1AHWema9om5GsgIdOjRmC1f03psliebz6d4k-uukHBo&e=  -o "${SCRIPT_DOWNLOAD}/launch-${LABEL}.${EXT}"
      ...
      if [[ "$ostype" == "macOS" ]]; then
        open_browser https://urldefense.proofpoint.com/v2/url?u=https-3A__github.com_radiant-2Drstats_docker_blob_master_install_rsm-2Dmsba-2Dmacos.md&d=DwIGAg&c=-35OiAkTchMrZOngvJPOeA&r=Fl9jXwBiBhOXNPxlgSZKqSEZiBiPWs1diKtm8L8hkjw&m=dKnl0Zu1E_xKFdSYdXmzt7bxtrBIg5RlcxG-BpgA_VrGxp0RzlpV-l_r-7ohiVX6&s=Hvo0DFZIXQHpVxH-I7ZBkkkboxpWsRX9y1Gwde_Jqdo&e= 
      elif [[ "$ostype" == "Windows" ]]; then
        open_browser https://urldefense.proofpoint.com/v2/url?u=https-3A__github.com_radiant-2Drstats_docker_blob_master_install_rsm-2Dmsba-2Dwindows-2D1909.md&d=DwIGAg&c=-35OiAkTchMrZOngvJPOeA&r=Fl9jXwBiBhOXNPxlgSZKqSEZiBiPWs1diKtm8L8hkjw&m=dKnl0Zu1E_xKFdSYdXmzt7bxtrBIg5RlcxG-BpgA_VrGxp0RzlpV-l_r-7ohiVX6&s=66eiooGMYDAIbnaWMVLrXZu0_liUias3jX_OF1xcXu0&e= 
      elif [[ "$ostype" == "WSL2" ]]; then
        open_browser https://urldefense.proofpoint.com/v2/url?u=https-3A__github.com_radiant-2Drstats_docker_blob_master_install_rsm-2Dmsba-2Dwindows.md&d=DwIGAg&c=-35OiAkTchMrZOngvJPOeA&r=Fl9jXwBiBhOXNPxlgSZKqSEZiBiPWs1diKtm8L8hkjw&m=dKnl0Zu1E_xKFdSYdXmzt7bxtrBIg5RlcxG-BpgA_VrGxp0RzlpV-l_r-7ohiVX6&s=KXE_Y9wDkRTbu8wRpPvOsNx7VPcGLhWytgWgREGRBkY&e= 
      elif [[ "$ostype" == "ChromeOS" ]]; then
        open_browser https://urldefense.proofpoint.com/v2/url?u=https-3A__github.com_radiant-2Drstats_docker_blob_master_install_rsm-2Dmsba-2Dchromeos.md&d=DwIGAg&c=-35OiAkTchMrZOngvJPOeA&r=Fl9jXwBiBhOXNPxlgSZKqSEZiBiPWs1diKtm8L8hkjw&m=dKnl0Zu1E_xKFdSYdXmzt7bxtrBIg5RlcxG-BpgA_VrGxp0RzlpV-l_r-7ohiVX6&s=xoGg-n3xGvkKyYyiREqRnamP8Vpd1CBRBplXgJRNHFk&e= 
      else
        open_browser https://urldefense.proofpoint.com/v2/url?u=https-3A__github.com_radiant-2Drstats_docker_blob_master_install_rsm-2Dmsba-2Dlinux.md&d=DwIGAg&c=-35OiAkTchMrZOngvJPOeA&r=Fl9jXwBiBhOXNPxlgSZKqSEZiBiPWs1diKtm8L8hkjw&m=dKnl0Zu1E_xKFdSYdXmzt7bxtrBIg5RlcxG-BpgA_VrGxp0RzlpV-l_r-7ohiVX6&s=o6YLrZSZDaQo1Y2qlOyry10iAQY2P3F4UnBpsGNB0l8&e= 
      fi
      $0 --help
      echo "Press any key to continue"
      echo "-----------------------------------------------------------------------"
      ...
      echo "Note: This requires an account at https://urldefense.proofpoint.com/v2/url?u=https-3A__hub.docker.com_&d=DwIGAg&c=-35OiAkTchMrZOngvJPOeA&r=Fl9jXwBiBhOXNPxlgSZKqSEZiBiPWs1diKtm8L8hkjw&m=dKnl0Zu1E_xKFdSYdXmzt7bxtrBIg5RlcxG-BpgA_VrGxp0RzlpV-l_r-7ohiVX6&s=mvApdqpcz4ofg0_0OOdzKzr5l7eLGv0gOz4Yxpj39PQ&e= "
      ...
      if [ "${menu_push}" == "y" ]; then
        {
          ...
          echo "Please make sure you have an account at https://urldefense.proofpoint.com/v2/url?u=https-3A__hub.docker.com_&d=DwIGAg&c=-35OiAkTchMrZOngvJPOeA&r=Fl9jXwBiBhOXNPxlgSZKqSEZiBiPWs1diKtm8L8hkjw&m=dKnl0Zu1E_xKFdSYdXmzt7bxtrBIg5RlcxG-BpgA_VrGxp0RzlpV-l_r-7ohiVX6&s=mvApdqpcz4ofg0_0OOdzKzr5l7eLGv0gOz4Yxpj39PQ&e= "
          echo "-----------------------------------------------------------------------"
          sleep 3
        }
      fi

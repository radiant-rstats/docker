...
- [Installing the RSM-MSBA-ARM computing environment on macOS systems with and ARM chip (e.g., M3)](#installing-the-rsm-msba-arm-computing-environment-on-macos-systems-with-an-ARM-chip)
- [Updating the RSM-MSBA-ARM computing environment on macOS systems with an ARM chip](#updating-the-rsm-msba-arm-computing-environment-on-macos-systems-with-an-ARM-chip)
...
## Installing the RSM-MSBA-ARM computing environment on macOS systems with an ARM chip (e.g., M3)
...
## Updating the RSM-MSBA-ARM computing environment on macOS systems with an ARM chip
...
You should always stop the `rsm-msba-arm` docker container using `q` (+ Enter) in the launch menu. If you want a full cleanup and reset of the computational environment on your system, however, execute the following commands from a (bash) terminal to (1) remove prior R(studio) and Python packages, (2) remove all docker images, networks, and (data) volumes, and (3) 'pull' only the docker image you need (e.g., rsm-msba-arm):

...
* `launch -v ~/rsm-msba` will treat the `~/rsm-msba` directory on the host system (i.e., your Linux computer) as the home directory in the docker container. This can be useful of you want to setup a particular directory that will house multiple projects
